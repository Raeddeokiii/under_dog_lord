#!/usr/bin/env python3
"""Add status effect (CC) system"""

status_script = '''/// @file scr_status.gml
/// @desc 상태이상(CC) 시스템
...
if __name__ == "__main__":
    ...
    import os
    script_dir = 'D:/gml_game/under_dog_lord/scripts/scr_status'
    os.makedirs(script_dir, exist_ok=True)

    # Write the status script
    with open(f'{script_dir}/scr_status.gml', 'w', encoding='utf-8') as f:
        f.write(status_script)
    print("Created scr_status.gml")

    # Create the .yy resource file
    yy_content = '''{
  "$GMScript":"",
  "%Name":"scr_status",
  ...
  "resourceVersion":"2.0",
    ...
    with open(f'{script_dir}/scr_status.yy', 'w', encoding='utf-8') as f:
        f.write(yy_content)
    print("Created scr_status.yy")

    print("\nDone! Status effect system created.")
    print("\nNOTE: You need to add this script to the project in GameMaker IDE")
    print("or add it to under_dog_lord.yyp manually.")
